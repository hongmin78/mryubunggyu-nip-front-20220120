...
//	address public _owner ;
	constructor (address __admincontract, address __feecollector) {
...
//		require( _t o != address(0) , "ERR() invalid beneficiary" );
		...
		uint256 admin_fee_rate = 288 ;
			...
			uint256 admin_fee_amount = _amounttopay * admin_fee_rate / 10000 ;
      	address vault = IAdmin_nft( _admincontract )._vault() ;
				if (_feecollector == address(0)){}
				else{
			IERC20 ( _paymeansaddress).transfer ( _feecollector , _amounttopay * admin_fee_rate / 10000 ) ;
