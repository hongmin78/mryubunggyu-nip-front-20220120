const messages = {
  ...
  MSG_TX_REQUEST_SENT: "Request sent", // 요청이 전송되었습니다'
  ...
  MSG_DONE_REGISTERING: "Joined!", // 가입되었습니다'
  MSG_PLEASE_REQUEST_EMAIL_VERIFY_CODE: "Please request verification code", // 이메일 인증을 요청하세요'
  MSG_REFERER_CODE_INVALID: "Invalid referer code", // 존재하지 아니하는 추천인코드입니다'
  MSG_BALANCE_NOT_ENOUGH: "Balance is not enough", // 잔액이 불충분합니다'
  MSG_DONE_LIKE: "Added to the liked list!",
  MSG_DONE_UNLIKE: "Removed from the liked list!",
  MSG_COPIED: "Copied",
